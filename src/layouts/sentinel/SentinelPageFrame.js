    ...
    <>
      <GlobalStyles
        styles={{
          ...
          ".sentinel-page [data-page-reveal]": {
            animation: `${pageReveal} 520ms cubic-bezier(.22,1,.36,1) both`,
          },
          "@media (prefers-reduced-motion: reduce)": {
            ".sentinel-page [data-page-reveal]": { animation: "none" },
          },
        }}
      />
      <Box
        className="sentinel-page"
        sx={{
          minHeight: "100vh",
          overflow: "hidden",
